...
export function CardEvents({title, id, description, date, hour, image, category, label, status, percent}) {
    return(
        <NavLink to="/attimo/activityDetails" state={id} className="bg-white transition duration-300 dark:bg-clr-dark-third rounded-lg overflow-hidden dark:hover:brightness-[1.2] hover:brightness-[.80] cursor-pointer">
            <div className='h-40 overflow-hidden'><img className="w-full bg-cover" src={`${image}`} alt="Activity Image" /></div>
            <div className="p-4">
