...
const EditProfileModal = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <button
        className="fixed inset-0 bg-black bg-opacity-[0.01]"
        onClick={onClose}
      ></button>
      <form
        onSubmit={handleUpdateProfile}
        encType="multipart/form-data"
        className="bg-white dark:bg-clr-dark-bg rounded-md shadow-lg absolute left-[5.5rem] bottom-[0rem] w-[28rem] md:w-[26rem] xs:w-[24.3rem] p-8"
      >
