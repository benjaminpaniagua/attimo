...
export function InputSearch() {
    return (
        <div className="md:w-full flex justify-between bg-clr-light-gray/40 text-clr-dark-gray rounded-md overflow-hidden dark:bg-clr-dark-gray/30 dark:text-clr-light-gray">
